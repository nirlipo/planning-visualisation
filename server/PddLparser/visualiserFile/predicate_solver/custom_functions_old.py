...
def custom_function_controller(fname,obj_dic,setting,space):
    if fname == "distributex":
        return distributex(obj_dic, setting,space)
    elif fname == "distribute_grid_around_pointx":
        return distribute_grid_around_pointx(obj_dic,setting,space)
    elif fname == "distribute_grid_around_pointy":
        return distribute_grid_around_pointy(obj_dic,setting,space)
    elif fname == "distribute_vertical":
        return distribute_vertical(obj_dic, setting,space)
    elif fname == "apply_smaller":
        return apply_smaller(obj_dic, setting,space)
    elif fname == "shiftx":
        return shiftx(obj_dic, setting,space)
    elif fname == "distributey":
        return distributey(obj_dic, setting,space)
    elif fname == "distribute_horizontal":
        return distribute_horizontal(obj_dic, setting,space)
