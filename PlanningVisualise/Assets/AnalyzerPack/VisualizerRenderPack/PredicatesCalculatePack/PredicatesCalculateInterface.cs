...
namespace PlanVisualizerArchitecture.AnalyzerPack.VisualizerRenderPack.InterpreterPack {
   public static class PredicatesCalculateInterface {
      ...
      /// <param name="argScriptInfoItem">The source ScriptInfoItem object</param>
      /// <param name="argProjectVisualizeItem">The target ProjectVisualizeItem object</param>
      public static void AnalyzePlan(ScriptInfoItem argScriptInfoItem, ProjectVisualizeItem argProjectVisualizeItem) {
