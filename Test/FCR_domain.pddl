(define (domain FCR)
  ...
  (:action wolf_get_on_boat :parameters (?y - (either southbank northbank) ?boat - boat)
   :precondition (and
                    (at wolf southbank)
                    (at goat northbank)
                    (at cabbage southbank)
  ...
  (:action goat_get_on_boat :parameters (?y - (either southbank northbank) ?boat - boat)
   :precondition (and
                    (or
                        (and
                            (at wolf southbank)
  ...
  (:action cabbage_get_on_boat :parameters (?y - (either southbank northbank) ?boat - boat)
   :precondition (and
                    (at wolf northbank)
                    (at goat southbank)
                    (at cabbage southbank)
  ...
  (:action wolf_get_off_boat :parameters (?y - (either southbank northbank) ?boat - boat)
   :precondition (and
                    (at_bank ?boat ?y)
                    (full_boat ?boat)
  ...
  (:action goat_get_off_boat :parameters (?y - (either southbank northbank) ?boat - boat)
   :precondition (and
                    (at_bank ?boat ?y)
                    (full_boat ?boat)
                    (target_in_boat goat ?boat)
  ...
  (:action cabbage_get_off_boat :parameters (?y - (either southbank northbank) ?boat - boat)
   :precondition (and
                    (at_bank ?boat ?y)
                    (full_boat ?boat)
